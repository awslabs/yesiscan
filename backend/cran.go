...
var (
	...
	// stripTrashCran is used to replace all strings which include
	// file and a file name and sometimes have a + or | before it. For example:
	// "| file LICENSE". This also replaces new line characters.
